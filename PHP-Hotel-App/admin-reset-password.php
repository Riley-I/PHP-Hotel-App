            ...
            if($stmt->execute()){
                ...
                ?>
                            <script type="text/javascript">
                                window.location.href = 'http://rileyidev.ca:8081/PHP-Hotel-App/admin-login.php/';
                                </script>
                                <?php
                exit();
            } else{
...
<html lang="en">
  <head>
        <title>Backwoods Lodge Login</title>
        <meta charset="UTF-8">
    ...
    <div class="wrapper">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post"> 
            ...
            <div class="form-group">
                ...
                <a class="btn btn-link ml-2" href="admin-login.php">Cancel</a>
            </div>
        </form>
    </div>    
</body>
